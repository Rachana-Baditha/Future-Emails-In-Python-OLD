#This file is for handling statistics of emails
...
def updateSentStats(stats,hubdata,delivery):

    #Update Statistics after sending the email 
...
def updateGotStats(stats,hubinfo,delivery):

    #Update Statistics after recieving the email
